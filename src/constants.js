...
export const bibleTopics = [
  { id: "love", name: "Love", icon: "Heart", references: ["1 Corinthians 13:4", "John 3:16", "Romans 5:8", "1 John 4:8"] },
  { id: "faith", name: "Faith", icon: "Shield", references: ["Hebrews 11:1", "Ephesians 2:8", "James 2:17", "Matthew 17:20"] },
  { id: "strength", name: "Strength", icon: "Zap", references: ["Philippians 4:13", "Isaiah 40:31", "Psalm 27:1", "Joshua 1:9"] },
  { id: "peace", name: "Peace", icon: "Cloud", references: ["John 14:27", "Philippians 4:7", "Matthew 5:9", "Numbers 6:24"] },
  { id: "wisdom", name: "Wisdom", icon: "Lightbulb", references: ["James 1:5", "Proverbs 3:5", "Proverbs 9:10", "Psalm 111:10"] }
];
